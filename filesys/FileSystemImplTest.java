...
public class FileSystemImplTest {
    ...
    public void testRmFileSuccess() throws Exception {
        fileSystem.touch("/testfile.txt", ROOT_USER);

        fileSystem.rm("/testfile.txt", ROOT_USER, false);
    ...
    public void testRmRecursiveSuccess() throws Exception {
        fileSystem.mkdir("/parent", ROOT_USER);
        fileSystem.mkdir("/parent/child", ROOT_USER);
        fileSystem.touch("/parent/file.txt", ROOT_USER);
    ...
    public void testTouchSuccess() throws Exception {
        ...
        fileSystem.read("/testfile.txt", ROOT_USER, buffer);
    }
    ...
    public void testTouchInSubdirectory() throws Exception {
        ...
        fileSystem.touch("/testdir/testfile.txt", ROOT_USER);

        byte[] buffer = new byte[0];
        fileSystem.read("/testdir/testfile.txt", ROOT_USER, buffer);
    }
    ...
    public void testTouchDirectoryExists() throws Exception {
        fileSystem.mkdir("/testdir.txt", ROOT_USER);
        fileSystem.touch("/testdir.txt", ROOT_USER);
    }
    ...
    public void testWriteSuccess() throws Exception {
        ...
        fileSystem.write("/testfile.txt", ROOT_USER, false, dataToWrite);
    ...
    public void testWriteAppend() throws Exception {
        ...
        fileSystem.write("/testfile.txt", ROOT_USER, false, initialData);

        byte[] additionalData = "World!".getBytes();
        fileSystem.write("/testfile.txt", ROOT_USER, true, additionalData);
    ...
    public void testWriteOverwrite() throws Exception {
        ...
        fileSystem.write("/testfile.txt", ROOT_USER, false, newData);
    ...
    public void testReadEmptyFile() throws Exception {
        fileSystem.touch("/emptyfile.txt", ROOT_USER);

        byte[] buffer = new byte[10];
        fileSystem.read("/emptyfile.txt", ROOT_USER, buffer);
    ...
    public void testReadBufferSmallerThanContent() throws Exception {
        ...
        fileSystem.read("/testfile.txt", ROOT_USER, smallBuffer);
    ...
    public void testMvFileSuccess() throws Exception {
        fileSystem.touch("/sourcefile.txt", ROOT_USER);
        byte[] data = "Test data".getBytes();
        fileSystem.write("/sourcefile.txt", ROOT_USER, false, data);

        fileSystem.mv("/sourcefile.txt", "/destfile", ROOT_USER);

        try {
            byte[] buffer = new byte[10];
            fileSystem.read("/sourcefile.txt", ROOT_USER, buffer);
            fail("Deveria lançar CaminhoNaoEncontradoException");
        } catch (CaminhoNaoEncontradoException e) {
        }
    ...
    public void testMvDirectorySuccess() throws Exception {
        ...
        fileSystem.touch("/sourcedir/file.txt", ROOT_USER);
        ...
        byte[] buffer = new byte[0];
        fileSystem.read("/destdir/file.txt", ROOT_USER, buffer);
    }
    ...
    public void testMvDestinationExists() throws Exception {
        fileSystem.touch("/source.txt", ROOT_USER);
        byte[] sourceData = "Source data".getBytes();
        fileSystem.write("/source.txt", ROOT_USER, false, sourceData);

        fileSystem.touch("/dest.txt", ROOT_USER);
        byte[] destData = "Destination data".getBytes();
        fileSystem.write("/dest.txt", ROOT_USER, false, destData);

        fileSystem.mv("/source.txt", "/dest", ROOT_USER);

        try {
            byte[] buffer = new byte[20];
            fileSystem.read("/source.txt", ROOT_USER, buffer);
            fail("Deveria lançar CaminhoNaoEncontradoException");
        } catch (CaminhoNaoEncontradoException e) {
        }
    ...
    public void testLsNonEmptyDirectory() throws Exception {
        fileSystem.mkdir("/testdir", ROOT_USER);
        fileSystem.touch("/testdir/file1.txt", ROOT_USER);
        fileSystem.touch("/testdir/file2.txt", ROOT_USER);
    ...
    public void testLsRecursive() throws Exception {
        ...
        fileSystem.touch("/testdir/file1.txt", ROOT_USER);
        fileSystem.mkdir("/testdir/subdir", ROOT_USER);
        fileSystem.touch("/testdir/subdir/file2.txt", ROOT_USER);
    ...
    public void testCpFileSuccess() throws Exception {
        ...
        fileSystem.cp("/sourcefile.txt", "/destfile", ROOT_USER, false);

        byte[] sourceBuffer = new byte[20];
        fileSystem.read("/sourcefile.txt", ROOT_USER, sourceBuffer);
    ...
    public void testCpDirectoryRecursive() throws Exception {
        ...
        fileSystem.touch("/sourcedir/file.txt", ROOT_USER);
        byte[] data = "Test data".getBytes();
        fileSystem.write("/sourcedir/file.txt", ROOT_USER, false, data);
        fileSystem.mkdir("/sourcedir/subdir", ROOT_USER);
        fileSystem.touch("/sourcedir/subdir/file2.txt", ROOT_USER);
        ...
        fileSystem.read("/destdir/subdir/file2.txt", ROOT_USER, buffer2);
    }
    ...
    public void testComplexScenario() throws Exception {
        ...
        fileSystem.chmod("/home", ROOT_USER, TEST_USER, "rwx");
        fileSystem.chmod("/home", ROOT_USER, OTHER_USER, "rwx");

        fileSystem.mkdir("/home/user1", ROOT_USER);
        fileSystem.mkdir("/home/user2", ROOT_USER);

        fileSystem.touch("/home/user1/file1.txt", TEST_USER);

        byte[] data1 = "User 1 data".getBytes();
        fileSystem.write("/home/user1/file1.txt", TEST_USER, false, data1);

        fileSystem.touch("/home/user2/file2.txt", OTHER_USER);
        byte[] data2 = "User 2 data".getBytes();
        fileSystem.write("/home/user2/file2.txt", OTHER_USER, false, data2);
        byte[] buffer = new byte[20];
        fileSystem.read("/home/user2/file2.txt", TEST_USER, buffer);

        byte[] buffer2 = new byte[20];
        fileSystem.read("/home/user2/file2.txt", ROOT_USER, buffer2);


        byte[] buffer3 = new byte[20];
        fileSystem.read("/home/user2/file2.txt", TEST_USER, buffer3);
        fileSystem.write("/home/user2/file2.txt", TEST_USER, false, "Attempt to modify".getBytes());
